...
def ResNet34(num_classes=34):
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes)


def ResNet50_Basic(num_classes=34):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes)


def ResNet101_Basic(num_classes=34):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes)


def ResNet152(num_classes=34):
    return ResNet(Bottleneck, [3, 8, 36, 3], num_classes)


def test_ResNet():
    net = ResNet34().cuda()
    print( summary(net, input_size=(8, 5000), batch_size=2) )
