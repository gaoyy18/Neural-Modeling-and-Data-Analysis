...
class ResNeXt(BasicModule):
    def __init__(self, num_blocks, cardinality, bottleneck_width, num_classes=34):
        ...
        self.linear = nn.Linear(16 * cardinality * bottleneck_width + 2, num_classes)
