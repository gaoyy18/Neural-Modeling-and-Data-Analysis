...
class RNN(nn.Module):
    def __init__(self, input_size, hidden_size1, hidden_size2, hidden_size3, num_classes=34):
        ...
        self.rnn1=LSTM0(input_size, hidden_size1, hidden_size2)
        self.rnn2=LSTM0(input_size, hidden_size1, hidden_size2)
        self.rnn3=LSTM0(input_size, hidden_size1, hidden_size2)
        self.rnn4=LSTM0(input_size, hidden_size1, hidden_size2)
        self.rnn5=LSTM0(input_size, hidden_size1, hidden_size2)
        self.rnn6=LSTM0(input_size, hidden_size1, hidden_size2)
        self.rnn7=LSTM0(input_size, hidden_size1, hidden_size2)
        self.rnn8=LSTM0(input_size, hidden_size1, hidden_size2)
...
def lstm_channel8_model(pretrained=False, **kwargs):
    """Constructs a rnn_lstm model.
